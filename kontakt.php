                ...
                <br />
                    <div class="row section-contact">
                            <div class="col-sm-12 col-lg-8">
                                ...
                                <div class="row text-secondary">
                                    <div class="col-6">
                                        <p>Mathildenstr 25. 82152 Planegg - Munchen</p>
                                    </div>
                                    <div class="col-6">
                                        <p>+49 176 32261220</p>
                                    </div>
                            ...
                            <div class="col-sm-12 col-lg-4">
                                ...
                                <div class="row">
                                    <div class="col p-3">
                                        ...
                                        &nbsp;
                                        &nbsp;
                                        <img src="assets/img/facebook.png" title="facebook" />
                                    </div>
                                </div>
                            </div> 
                            <div class="col-12 text-primary">Montag bis Freitag von 9:00 bis 18:00 Uhr.</div>
                    </div>
                    <br/>
                    <div class="row">
                        <div class="col text-center">
                            <img src="assets/img/capa21.png" class="img-fluid" alt="Kontakt" />
                        </div>
                    </div>
                </main>
