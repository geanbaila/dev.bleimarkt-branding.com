    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 ms-sm-auto d-md-block">
                ...
                <main>
                    <br />
                    <div class="row align-items-center menu2">
                        <div class="col-6">
                            <ul class="nav justify-content-center d-flex align-items-end">
                                <li class="nav-item ">
                                    <a class="nav-link text-light fs-6 fw-bold" aria-current="page" href="uberuns.php">Naturbelassen</a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link text-light fs-6 fw-bold" aria-current="page" href="uberuns.php">Prozessorientiert</a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link text-light fs-6 fw-bold" aria-current="page" href="uberuns.php">Persönlich</a>
                                </li>
                             </ul>
                        </div>
                        <div class="col-6 ">
                    ...
                    <div class="row gx-3" id="Gartengestaltung">
                        ...
                        <div class="col-lg-6 align-self-center px-5 ">
                            <h6 class="text-secondary  p-3">Wilkommen to Der Garten Bauer</h6>
                            <h2 class="text-primary p-3">Gartengestaltung und  Neuanlegung</h2>
                    ...
                    <br/>
                    <div class="row gx-3" id="Natursteinarbeiten">
                    ...
                    <br/>
                    <div class="row gx-3" id="Neupflanzungen">
                        <div class="col-lg-6 d-none d-lg-block align-self-center ">
                            <img src="img/3.jpg" class="img-fluid mx-auto d-block">
                        </div>
                        <div class="col-lg-6 align-self-center px-5 ">
